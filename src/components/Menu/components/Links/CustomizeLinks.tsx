...
function CustomizeLinks(): JSX.Element {
  ...
  return (
    <form className="flex flex-col col-span-3 p-8 max-h-full bg-white rounded-md">
      <div className="flex flex-col gap-y-4 h-full bg-white">
        ...
        text-custom-purple font-semibold text-nowrap hover:bg-custom-lavender px-5 gap-x-1 rounded-md
          w-full h-8 min-h-8"
